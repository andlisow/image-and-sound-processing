package main.java.pl.lodz.p.ftims.poid.exercise3.model;// Wav file IO class
// A.Greensted
...
public class WavFile
{
    ...
    public WavFile(WavFile other) {
        this.file = other.file;
        this.ioState = other.ioState;
        this.bytesPerSample = other.bytesPerSample;
        this.numFrames = other.numFrames;
        this.oStream = other.oStream;
        this.iStream = other.iStream;
        this.floatScale = other.floatScale;
        this.floatOffset = other.floatOffset;
        this.wordAlignAdjust = other.wordAlignAdjust;
        this.numChannels = other.numChannels;
        this.sampleRate = other.sampleRate;
        this.blockAlign = other.blockAlign;
        this.validBits = other.validBits;
        this.buffer = other.buffer;
        this.bufferPointer = other.bufferPointer;
