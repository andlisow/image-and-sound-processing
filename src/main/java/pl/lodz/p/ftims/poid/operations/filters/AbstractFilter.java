...
import main.java.pl.lodz.p.ftims.poid.operations.comparison.Mae;
import main.java.pl.lodz.p.ftims.poid.operations.comparison.Mse;
import main.java.pl.lodz.p.ftims.poid.operations.comparison.Psnr;
        ...
        if(this instanceof MeanFilter || this instanceof MedianFilter){
            ...
            try {
                if (originalImage.getName().contains("lenac")) {
                    modelImage = ImageUtil.readImageFromFile(new File("/home/andrzej/Pulpit/POID/SRC/image-and-sound-processing/src/main/resources/bit24/lenac_small.bmp"));
                } else if (originalImage.getName().contains("lena")) {
                    modelImage = ImageUtil.readImageFromFile(new File("/home/andrzej/Pulpit/POID/SRC/image-and-sound-processing/src/main/resources/bit8/lena_small.bmp"));
                } else {
                    return;
                }
            } catch (IOException e) {
